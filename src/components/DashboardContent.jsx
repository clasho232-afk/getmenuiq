    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
      ...
      <div style={{ display: 'flex', gap: '1.5rem' }}>
        ...
        <PricingCard 
          ...
          gradient="linear-gradient(to bottom, rgba(99, 153, 34, 0.30) 0%, rgba(255,255,255,0) 55%)"
          items={[
        ...
        <PricingCard 
          ...
          gradient="linear-gradient(to bottom, rgba(239, 159, 39, 0.30) 0%, rgba(255,255,255,0) 55%)"
          items={[
